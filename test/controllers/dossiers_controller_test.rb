...
class DossiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dossier" do
    assert_difference('Dossier.count') do
      post dossiers_url, params: { dossier: { ecole_id: @dossier.ecole_id, libelle: @dossier.libelle } }
    end
  ...
  test "should update dossier" do
    patch dossier_url(@dossier), params: { dossier: { ecole_id: @dossier.ecole_id, libelle: @dossier.libelle } }
